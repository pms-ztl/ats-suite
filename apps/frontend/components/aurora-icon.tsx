// components/aurora-icon.tsx
// Aurora prototype icon set, ported verbatim from claude-design/icons.jsx.
// 24px stroke geometry (Lucide-style). The Aurora HTML/JSX prototypes call
// <Icon name="..." />; this is the real-app shim so those ports render
// unchanged. New code can use lucide-react directly; this exists for fidelity.
...
/** Brand mark, overlapping aperture leaves (simple geometry). */
export function Logo({ size = 26 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-hidden="true">
      <rect x="1" y="1" width="30" height="30" rx="9" fill="var(--c-brand)" />
      <path d="M8.5 23.5L16 7l7.5 16.5" stroke="var(--c-on-brand)" strokeWidth="2.8" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 16.5h8" stroke="var(--c-on-brand)" strokeWidth="2.8" strokeLinecap="round" />
