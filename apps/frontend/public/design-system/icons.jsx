/* icons.jsx, cohesive 24px stroke icon set (Lucide-style geometry) */
const ICONS = {
...
/* tiny brand mark, overlapping aperture leaves (simple geometry) */
function Logo({ size = 26 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-hidden="true">
      <rect x="1" y="1" width="30" height="30" rx="9" fill="var(--brand)" />
      <path d="M8.5 23.5L16 7l7.5 16.5" stroke="var(--on-brand)" stroke-width="2.8" fill="none" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 16.5h8" stroke="var(--on-brand)" stroke-width="2.8" stroke-linecap="round"/><circle cx="16" cy="6.2" r="2.2" fill="#9b8cff"/>
    </svg>
  );
}

Object.assign(window, { ICONS, Icon, Logo });
